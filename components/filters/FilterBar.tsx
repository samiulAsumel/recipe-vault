...
import { localizeContinentName, localizeDietaryLabel, MEAL_TIME_LABELS } from "@/lib/i18n/labels";
...
export function FilterBar({
  ...
  const hasActiveFilters = dietaryValues.length + mealValues.length + continentValues.length > 0;
